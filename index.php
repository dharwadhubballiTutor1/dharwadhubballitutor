...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1433283177021826&ev=PageView&noscript=1" /></noscript>
...
<a class="blink_me social-icon" href=Job-Assistance.php> Job Assistance</a><br/>
                ...
                <div class="container">
                    <a href="Job-Assistance.php" class="mobileshow btn-btn-outline-warning" role="button">Job
                        Assistance</a>
                </div>
            </div><br />
    ...
    <nav class="navbar navbar-expand-md bg-light">
        ...
        <div class="collapse navbar-collapse" id=navbarNavDropdown>
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href=# id=navbarDropdownMenuLink role=button
                        data-toggle=dropdown aria-haspopup=true aria-expanded=false> Trainings </a>

                    <div class=dropdown-menu aria-labelledby=navbarDropdownMenuLink>
                        <a class=dropdown-item href=Web-Designing-and-Development-Training.php>Web Designing and
                            Development</a>
            ...
            <ul class=navbar-nav>
                <li class=nav-item>
                    <a href=action-page.php class="nav-item nav-link px-2" data-toggle=modal
                        data-target=#exampleModalCenter>Register</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class=carousel-inner>
            ...
            <div class="carousel-item active">
                <picture>
                    ...
                    <img src=media/img/slide0.jpg alt=Learning-is-earning-image class="d-block img-fluid" width="1920"
                        height="720" />
                </picture>
            ...
            <div class=carousel-item>
                <picture>
                    ...
                    <img src=media/img/slide1.jpg alt=Registeration-image class="d-block img-fluid" width="1920"
                        height="720" />
                </picture>
                <div class="carousel-caption d-none d-md-block">
                    <button type=button class="btn btn-outline-primary btn-lg" data-toggle=modal
                        data-target=#demomodal>Register For Demo Classes</button>
                    <br />
                    <p class=themecolor>Discover your potenial through our wide range of courses and get trained by the
                        best trainers with Industry experience</p>
                </div>
            </div>
            <div class=carousel-item>
                <picture>
                    <source srcset=media/img/mobileslide2.jpg media="(max-width: 768px)" width="768" height="400" />
                    <img src=media/img/slide2.jpg alt=Top-skills-image class="d-block img-fluid" width="1920"
                        height="720" />
                </picture>
            ...
            <div class=carousel-item>
                <picture>
                    ...
                    <img src=media/img/slide3.jpg alt=Takeaways-from-learning-image class="d-block img-fluid"
    ...
    <div class="container-fluid row row-cols-1 row-cols-md-2 row-cols-lg-4 justify-content-center align-self-center">
            ...
            <div class=card>
                <div class=card>
                    <div class=card-img-wrapper>
                        <img src=media/img/WDimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="WEB DESIGN AND DEVELOPMENT IMAGE" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Web Design and Development</h4><br />
                        <p class=card-text>Web design and development course/training is full stack course, where you
                            will learn both front end and back end coding...</p>
                        <a href=Web-Designing-and-Development-Training.php class="btn btn-outline-warning"
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/Pythonimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="Python Programming Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Python Programming</h4><br />
                        <p class=card-text>Python Programming course is an intensive programming training, where
                            participant would learn the basic to adavance level of concepts...</p>
                        <a href=Python-Programming-Training.php class="btn btn-outline-warning" role=button>View
                            More</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/cloudimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="Cloud Computing Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Cloud Computing</h4>
                        <br>
                        <p class=card-text>Our Cloud Computing Course will equip you to master significant concepts of
                            Cloud computing and implement its various services..</p>
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/androidimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="Android Development Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Android Development</h4><br />
                        <p class=card-text>On the off chance that the app Development field is something you are
                            thinking about as a career,then...</p>
                        <a href=Python-Programming-Training.php class="btn btn-outline-warning" role=button>View
                            More</a>
                    </div>
                </div>
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/civilimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="Civil Softwares Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Civil Design Software</h4><br />
                        <p class=card-text>Get the best training on Softwares like Revit,Autocad,3Dmax,Sketchup and
                            V-ray and kick-start your career in Civil Engineering.</p>
                        <a href=Civil-Design-Softwares-Training.php class="btn btn-outline-warning" role=button>View
                            More</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/programimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="Programming Languages Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Programming Languages</h4><br />
                        <p class=card-text>Programming Languages course is an intensive training on languages like C and
                            C++, where the participant would learn the basics to advanced concepts...</p>
                        <a href=Programming-Languages-Training.php class="btn btn-outline-warning" role=button>View
                            More</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/digitalimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="Digital Marketing Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>Digital Marketing</h4><br />
                        <p class=card-text>What we market might not have changed but how we market has changed. The
                            evolving discipline of digital marketing offers opportunities...</p>
        ...
        <div class="col mb-4">
            <div class=card>
                <div class="card h-100">
                    <div class=card-img-wrapper>
                        <img src=media/img/schoolimg.jpg class="img-responsive slider-img img-thumbnail"
                            alt="School Academics Image" height=100 width=500 />
                    </div>
                    <div class=card-body>
                        <h4 class=card-title style=color:#2a0a5e>School Academics</h4>

                        <p class=card-text>Our tutors excel in offering Mathematics and Science coaching for 8th,9th and
                            10th(STATE,CBSE & ICSE) Students.</p>
    ...
    <div class=container-fluid>
        <div class=row>
            ...
            <div class="col-md-8 justify-content-center align-self-center">
                <h3 class="h3 blink_me1"><a href=Internship.php class>FREE INTERNSHIPS ON LIVE PROJECT AVAILABLE</a>
                </h3>
                <p class="p2 para">Internships are a perfect way to gain valuable job experience for college students,
                    recent graduates or anyone contemplating a career change.Here at DharwadHubballiTutor you will be
                    working on live projects under well educated trainer. Below are some benefits of doing Internship at
                    DharwadHubballiTutor</p>
                <div class=row>
                    <div class=col-md-6>
                        <ul>
                    ...
                    <div class=col-md-6>
                        <div class=text-center>
                            <button type=button class="btn btn-warning" data-toggle=modal data-target=#modal1>ENROLL
                                NOW</button>
                        </div>
                    </div>
                </div>
                ...
                <div class=modal-body>
                    <form class=modal-content action="" method=POST>
                        <div class=container>
                            ...
                            <input type=text name=qualification1 class=form-control id=qualification1
        ...
        <div class="row justify-content-center py-3">
            ...
            <div class="col-md-3">
                ...
                <a class="social-icon fbicon" target=_blank rel="noopener"
                    href=https://www.facebook.com/DharwadhubballiTutor><i class="fab fa-facebook fa-2x fbicon"></i></a>
                <a class="social-icon twittericon" target=_blank rel="noopener" href=https://twitter.com/DharwadTutor><i
                        class="fab fa-twitter fa-2x twittericon"></i></a>
                <a class="social-icon instaicon" target=_blank rel="noopener"
                    href=https://www.instagram.com/dharwadhubballitutor><i
                        class="fab fa-instagram fa-2x instaicon"></i></a>
                <a class="social-icon instaicon" target=_blank rel="noopener"
                    href=http://www.linkedin.com/in/dharwadhubballitutor><i
                        class="fab fa-linkedin fa-2x linkedinicon"></i></a>
                <a class="social-icon whatsappicon" target="_blank" rel="noopener"
                    href="https://api.whatsapp.com/send?phone=919741237334&amp;text=Hithere!Ihaveaquestion"><i
                        class="fab fa-whatsapp fa-2x whatsappicon"></i></a>
                <br />
                <br />
                <div class=text-center>
                    <div class=col-md-7>
                        <span data-toggle=modal data-target=#modal2>
                            <button type=button class="btn btn-danger" data-toggle=tooltip data-placement=bottom
                                title="For Training or Internship">ENROLL</button>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <p>&copy; Copyright <script>
                    ...
                    </script> <span class=brandName>DharwadHubballiTutor</span>
                </p>
            </div>
        </div>
    </footer>
                ...
                <div class="modal-body">
                    <form class="modal-content" action="" method="POST">
                        <div class="container">
                            ...
                            <input type="tel" name="phone4" class="form-control" id="phone4" placeholder="Number"
                                required />
