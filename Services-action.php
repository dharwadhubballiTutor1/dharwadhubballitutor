...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="HTML,CSS,Java,Python,Digital Marketing,Revit,Autocad,Cloud Computing,Android,Graphic designing" />
  ...
  <body>
    <div class="brand-class container-fluid">
      <div class="row">
        <div class="col-md-6">
          ...
          <a class="social-icon fbicon" target="_blank" href="https://www.facebook.com/DharwadhubballiTutor"><i class="fab fa-facebook fa-lg fbicon fbheader"></i></a>
          <a class="social-icon twittericon" target="_blank" href="https://twitter.com/DharwadTutor"><i class="fab fa-twitter fa-lg twittericon twitterheader"></i></a>
          <a class="social-icon instaicon" target="_blank" href="https://www.instagram.com/dharwadhubballitutor/"><i class="fab fa-instagram fa-lg instaicon instaheader"></i></a>
          <a class="social-icon instaicon" target="_blank" href="http://www.linkedin.com/in/dharwadhubballitutor"><i class="fab fa-linkedin fa-lg linkedinicon linkedinheader"></i></a>
          <a class="social-icon whatsappicon" target="_blank" href="https://api.whatsapp.com/send?phone=917204817334&amp;text=Hi there! I have a question :)"><i class="fab fa-whatsapp fa-lg whatsappicon whatsappheader"></i></a>
        ...
        <div class="col-md-6">
          ...
          <button type="button" class="mobileshow">Job Assistance</button>
        </div>
      </div>
    </div>
    ...
    <nav class="navbar navbar-expand-md bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="action-page.php" class="nav-item nav-link px-2" data-toggle="modal" data-target="#modal3">Register</a>
          </li>
        </ul>
      </div>
    </nav>
    <div class="container">
      <div class="row row-eq-height">
        <div class="w-100 text-light">
          <h3 class="h3">THANK YOU FOR REQUESTING FOR QUOTE AT DHARWADHUBBALLITUTOR...WE WILL GET BACK TO YOU VERY SOON.</h3>
        </div>
      </div>
    </div>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form class="modal-content" action="Services-action.php" method="POST">
                        <div class="container">
                           <h1 style="color:#2a0a5e">Please fill in this form</h1>
