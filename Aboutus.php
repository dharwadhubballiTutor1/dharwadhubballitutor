...
<body>
  ...
  <div class="fb-customerchat" attribution="biz_inbox" page_id="100316711879103">
  </div>
  ...
  <div class=container>
    <div class="w-100 text-light">
      ...
      <div class=row>
        ...
        <div class=col-md-8>
          <h5 class=h5>Education /Training</h5>
          <p class=p2> Wide range of self employed and job employed trainings have been designed, so the students undergoing trainings with us will transform themselves to an entrepreneur or an employee. </p>
        </div>
      </div>
      <br />
      <div class=row>
        <div class=col-md-8>
          <h5 class=h5>Placement opportunity</h5>
          <p class=p2> If you are graduate and have required skills, then getting a job is very easy. Degree without skills is like a “Ring without Diamond”. We provide Job Assistance for skilled candidates , who have marked themselves as one in thousands.</p>
          <br />
        </div>
        <div class=col-md-4>
      ...
      <div class=row>
        ...
        <div class=col-md-8>
          <h5 class=h5>Internships</h5>
          <p class=p2> This step is an immediate bridge between academics and industries opt for the INTERNSHIPS on various technologies on LIVE assignments. Transform your resume by adding internships sections and get scrutinized easily by employers.</p>
        </div>
      </div>
      <br />
      <div class=row>
        <div class=col-md-8>
          <h5 class=h5>Service Providers</h5>
          <p class=p2> Wide range of Digital services are provided ranging from a simple digital business card to a dynamic, responsive Websites for your business .</p>
        </div>
        <div class=col-md-4>
