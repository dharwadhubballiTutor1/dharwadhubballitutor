            ...
            <div class="col-md-8">
               ...
               <br/>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-12">
                    <input type="text" class="form-select" id="coursesopted" name="coursesopted" required value= "<?php
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-12">
                        <input type="address" id="address" name="address" placeholder="Residential Address" class="form-control" required value= "<?php
                ...
                <div class="col-sm-12">
                    <a href="<?php echo 'uploads/', $admission->get_adhaarfile(); ?>" class="form-control" download > Click here to download Adhaar file</a>
                    </div>
                </div>
                <div class="col-md-6">
