    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h3 class="display-2" style="color:#2a0a5e">Trainers</h3> </br>
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-trainers-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-trainers" type="button" role="tab" aria-controls="pills-trainers"
                                aria-selected="true">Trainers list</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="pills-newtrainer-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-newtrainer" type="button" role="tab"
                                aria-controls="pills-newtrainer" aria-selected="false">New Trainer</button>
                        </li>

                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-trainers" role="tabpanel"
                        ...
                        <div class="tab-pane fade  " id="pills-newtrainer" role="tabpanel"
                            aria-labelledby="pills-newtrainer-tab">
                            <form class="form-horizontal" action="../Controller/newtrainer.php" method="POST"
