    ...
    <div class="card-body">
        <table class="table table-bordered" id="feepaymentlist">
            ...
            foreach ($feesdetails as $fees) {
                echo "<tr><td> " . $fees->get_modifieddate() . "</td><td>" . $fees->get_pfees() . "</td><td>" . $fees->get_pendingfees() . "</td> <td>" . $fees->get_duedate() . "</td><td>" . $fees->get_pmode() . "</td><td>"
            ...
            <div class="col-md-12">
                ...
                <form class="form" action="../Controller/feesaddition.php" method="POST" id="myForm"
                    ...
                    <div class="row g-3">
                        ...
                        <br />
                        <div class="col-md-6">
                            <div id="chargesdiv" class="col-md-12">
                                <label for="charges" class="col-md-6 control-label">Charges</label>
                                <div class="col-sm-12">
                                    <input type="text" id="charges" name="charges" class="form-control" readonly
                                        required value="<?php echo $collectfees->getCharges() ?>">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <td style="text-align:left" colspan="7">
                                                ...
                                                <p style="text-align:left"><i class="fas fa-phone"></i> +919741237334
                                                    ,+918007961759</p>
                                                <p style="text-align:left"><i class="fas fa-globe"></i>
                                                    www.dharwadhubballitutor.com </p>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                Student Name : <span id="studName">
                                                    <?php echo $collectfees->get_name(); ?>
                                                </span>
                                            </td>
                                            <td colspan="6">
                                                Admission Id : <span>
                                                    <?php echo $collectfees->get_admitid(); ?>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                                Address : <span>
                                                    <?php echo $collectfees->getAddress(); ?>
                                                </span>
                                            </td>
                                            <td colspan="6">
                                                Course Opted: <span>
                                                    <?php echo $collectfees->get_coursesopted(); ?>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                                Fees Plan:<span id="feesplan">
                                                    <?php echo $collectfees->get_feesplan(); ?>
                                                </span>

                                            </td>
                                            <td colspan="6">
                                                Total Amount : <span>
                                                    <?php echo $collectfees->get_tfees() ?>
                                                </span>
                                            </td>
        ...
        $('#TransactionModal').on('show.bs.modal', function (e) {
            ...
            $.getJSON(transactionUrl, function (data) {
                ...
                $.each(data, function (index, value) {
                    ...
                    $('#StudentTransaction tr:last').
                        append($(document.createElement('td')).prop({
                            innerHTML: value.pendingfees + "  (" + value.DueDate + ")",
                            style: "text-align:center"
                        }));
                    $('#StudentTransaction tr:last').
                        append($(document.createElement('td')).prop({
    ...
    $("#feesplan").change(function () {
        ...
        if ($(this).val() == "Finance") {
            ...
            if (parseInt($("#pfees").val()) > 0 && parseInt($("#pendingfees").val()) != 0) {
                ...
                var charges = $("#tfees").val() - $("#pfees").val();
            ...
            if (parseInt($("#pfees").val()) > 0 && parseInt($("#pendingfees").val()) != 0) {
                ...
                if (parseInt($(this).val()) < parseInt($("#tfees").val())) {
                    if ($("#charges").val() == 0) {
                        ...
                        var charges = $("#pendingfees").val() - $("#pfees").val();

                    }

                    $('#pendingfees').val(charges);
                }
