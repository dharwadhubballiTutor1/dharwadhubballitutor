                       ...
                       <div class="tab-pane fade show active" id="pills-fees" role="tabpanel"
                            ...
                            <table class=enquiries id="enquery">
                                ...
                                <?php 
                                 ...
                                 {
                                     echo "<tr><td> "  . $admission->get_id(). "</td><td>"  . $admission->get_name(). "</td><td>". $admission->get_coursesopted(). "</td><td>" .'<a class="btn btn-danger" href="../View/collectfees.php?id='.$admission->get_id().'" role="button">View Fees </a>'.'</td></tr>' ;
                                 }
                                 echo  "</tbody>";
                                ?>
                            </table>
