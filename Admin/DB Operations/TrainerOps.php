      ...
      public static function insert($trainerObj)
      {
        ...
        $connectionObj=$db->getConnection();
         ...
         $sql = "insert into trainers (`Name`, `Phone`, `Email`,`Qualification`,`Address`,`AdhaarNo`,`AdhaarFile`,`PhotoFile`) 
                values ('".$trainerObj->get_name()."','".$trainerObj->get_phone()."','".$trainerObj->get_email()."', '".$trainerObj->get_qualification()."','".$trainerObj->get_address()."','".$trainerObj->get_adhaarno()."','".$trainerObj->get_adhaarfile()."','".$trainerObj->get_photofile()."')";
